...
public class HSKDietTrackerSettings : ModSettings
{
    ...
    // Variety filter fallback: when no variety ingredients are left, cook from monotonous ones
    public bool varietyFilterFallback = false;
    ...
    public override void ExposeData()
    {
        ...
        Scribe_Values.Look(ref varietyFilterFallback, "varietyFilterFallback", false);
...
public class HSKDietTrackerMod : Mod
{
    ...
    public override void DoSettingsWindowContents(Rect inRect)
    {
        ...
        list.CheckboxLabeled("DT_SettingsNoStack".Translate(), ref Settings.preventMealStacking, "DT_SettingsNoStackTip".Translate());
        list.CheckboxLabeled("DT_SettingsVarietyFallback".Translate(), ref Settings.varietyFilterFallback, "DT_SettingsVarietyFallbackTip".Translate());
        list.Gap(8f);
